<?php
    ...
    if(isset($_POST['updateCustomer'])){
        ...
        $sql = $updateCustomer->updateCustomer($id, $email, $password, $name, $tel);
        if($sql){
            echo "<script>alert('บันทึกแก้ไขข้อมูลลูกค้าสำเร็จ ^^');</script>";
            echo "<script>window.location.href='index.php'</script>";
         }
        else{
            echo "<script>alert('ล้มมเหลว.. บันทึกแก้ไขข้อมูลลูกค้าไม่สำเร็จ!');</script>";
            echo "<script>window.location.href='updateCustomer.php?id=$id'</script>";
        }
    }
 ?>
    ...
    <section class="content">
          ...
          <div class="card">
            ...
            <div class="card-header">
              <strong class="card-title">แก้ไขข้อมูลลูกค้า</strong>
              <div align="right"> 
                <a href="index.php">      
            ...
            <?php
                ...
                $fetchCustomer_Update = new DB_con();
                $sql = $fetchCustomer_Update->fetchCustomer_Update($id);
            ...
            <div class="card-body p-1">
              ...
              <br>
              <br>
              <button type="submit" class="btn btn-warning form-control" name="updateCustomer">บันทึกแก้ไขข้อมูลลูกค้า</button>
              <br>
              <br>
              <br>
